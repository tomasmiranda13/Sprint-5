      ...
      <div className="bkgnd-main">
        <div className="features-wrap" id="features">
          <Feature
            ...
            description="The ability to use a smartphone, tablet, or computer to accces your account means your files follow you everywhere."
          />
          <Feature
        ...
        <div className="article-style">
          ...
          <div className="article-text">
            ...
            <p className="p-font-size">
              ...
              you <br />
              Covered all your file storage needs
            </p>
            <p className="p-font-size">
              Securely share files and folders with friends, family and
              collagues for live <br /> collaboration. No email attachments
              required
            </p>
            <div>
              <a href="">
